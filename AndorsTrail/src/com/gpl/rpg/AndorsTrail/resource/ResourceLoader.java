...
public final class ResourceLoader {
	...
	private static void prepareTilesets(DynamicTileLoader loader, int mTileSize) {
		...
		loader.prepareTileset(R.drawable.map_ground_9, "map_ground_9", src_mapTileSize, defaultTileSize);
		...
		loader.prepareTileset(R.drawable.map_plant_3, "map_plant_3", src_mapTileSize, defaultTileSize);
